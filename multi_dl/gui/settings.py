...
class SettingsWindow(QDialog):
    def __init__(self, manager, parent=None):
        ...
        download_directory_layout.addWidget(
            self.download_directory_edit, alignment=Qt.AlignmentFlag.AlignRight
        )
        ...
        temp_directory_layout.addWidget(
            self.temp_directory_edit, alignment=Qt.AlignmentFlag.AlignRight
        )
    ...
    def load_settings(self):
        ...
        self.download_directory_edit.setText(
            settings.value("download_directory", "", type=str)
        )
